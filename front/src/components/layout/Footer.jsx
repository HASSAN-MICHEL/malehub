...
// import { useTranslation } from 'react-i18next';
// import { useTheme } from '../../contexts/ThemeContext';
// import Newsletter from '../../components/Newsletter'; // Ajouter l'import
...
//           {/* Newsletter - Remplacer l'ancienne section CTA */}
//           <div>
//             <Newsletter />
//           </div>
//         </div>
...
export function Footer() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
        {/* Grille principale - Brand sur toute la largeur sur mobile */}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          {/* Brand - Première ligne sur mobile */}
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block">
              <img
                src={logoSrc}
          ...
          {/* Services et Entreprises - en deux colonnes sur mobile */}
          ...
          {/* Newsletter - en bas sur mobile, à droite sur desktop */}
          <div className="lg:col-span-1">
            <Newsletter />
          </div>
        </div>
