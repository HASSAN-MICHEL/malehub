...
const PAGE_BLOCKS = {
  ...
  incubator: [
    // Hero section
    { key: 'hero_badge', label: 'Badge Hero', type: 'text', hint: "Programme d'accompagnement", translatable: true },
    { key: 'hero_title_prefix', label: 'Préfixe titre Hero', type: 'text', hint: 'Rejoignez', translatable: true },
    { key: 'hero_title_highlight', label: 'Mot mis en avant', type: 'text', hint: "l'incubateur", translatable: true },
    { key: 'hero_title_suffix', label: 'Suffixe titre Hero', type: 'text', hint: 'de Malea Hub', translatable: true },
    { key: 'hero_description', label: 'Description Hero', type: 'textarea', hint: "Un programme d'accompagnement intensif pour transformer votre idée en startup à succès", translatable: true },
    { key: 'hero_image', label: 'Image Hero', type: 'image', hint: 'Image principale de la section Hero', translatable: false },
    { key: 'cta_button', label: 'Texte bouton CTA', type: 'text', hint: 'Postuler maintenant', translatable: true },
    { key: 'cta_message', label: 'Message WhatsApp CTA', type: 'textarea', hint: "Bonjour, je souhaite postuler à l'incubateur", translatable: true },
    // Program section
    { key: 'program_title', label: 'Titre Programme', type: 'text', hint: "Notre programme d'accompagnement", translatable: true },
    { key: 'program_subtitle', label: 'Sous-titre Programme', type: 'textarea', hint: 'Un parcours sur mesure pour les startups innovantes', translatable: true },
    { key: 'program_features', label: 'Points du programme', type: 'json', schema: 'program_features', hint: 'Titre + description pour chaque point', translatable: true },
    // Benefits section
    { key: 'benefits_title', label: 'Titre Avantages', type: 'text', hint: "Pourquoi rejoindre notre incubateur ?", translatable: true },
    { key: 'benefits_subtitle', label: 'Sous-titre Avantages', type: 'text', hint: 'Les clés de votre réussite', translatable: true },
    { key: 'benefits_items', label: 'Avantages (cartes)', type: 'json', schema: 'benefits', hint: 'Titre + description pour chaque avantage', translatable: true },
    // Stats section
    { key: 'stats_title', label: 'Titre Statistiques', type: 'text', hint: 'Ils nous font confiance', translatable: true },
    { key: 'stats_items', label: 'Statistiques (chiffres clés)', type: 'json', schema: 'stats', hint: 'Valeur + label pour chaque statistique', translatable: true },
    // Invest Club section
    { key: 'invest_club_badge', label: 'Badge Invest Club', type: 'text', hint: 'Malea Invest Club', translatable: true },
    { key: 'invest_club_title_prefix', label: 'Préfixe titre Invest Club', type: 'text', hint: 'Rejoignez le', translatable: true },
    { key: 'invest_club_title_highlight', label: 'Mot mis en avant', type: 'text', hint: 'Malea Invest Club', translatable: true },
    { key: 'invest_club_description', label: 'Description Invest Club', type: 'textarea', hint: "Devenez investisseur et participez à l'aventure des startups de demain", translatable: true },
    { key: 'invest_club_cta', label: 'Texte bouton', type: 'text', hint: 'Devenir investisseur', translatable: true },
    { key: 'invest_club_message', label: 'Message WhatsApp', type: 'textarea', hint: 'Bonjour, je souhaite rejoindre le Malea Invest Club', translatable: true },
    { key: 'invest_club_image', label: 'Image Invest Club', type: 'image', hint: 'Image illustrant le club des investisseurs', translatable: false },
    // Application CTA section
    { key: 'application_title', label: 'Titre section candidature', type: 'text', hint: "Prêt à rejoindre l'aventure ?", translatable: true },
    { key: 'application_description', label: 'Description candidature', type: 'textarea', hint: 'Postulez dès maintenant et faites décoller votre projet', translatable: true },
    { key: 'application_button', label: 'Texte bouton candidature', type: 'text', hint: 'Postuler', translatable: true },
    { key: 'application_message', label: 'Message WhatsApp candidature', type: 'textarea', hint: "Bonjour, je souhaite postuler à l'incubateur", translatable: true },
  ],
  training: [
    // Hero section
    { key: 'hero_badge', label: 'Badge Hero', type: 'text', hint: 'Formations Professionnelles', translatable: true },
    { key: 'hero_title_prefix', label: 'Préfixe titre Hero', type: 'text', hint: 'Devenez', translatable: true },
    { key: 'hero_title_highlight', label: 'Mot mis en avant', type: 'text', hint: 'opérationnel', translatable: true },
    { key: 'hero_title_suffix', label: 'Suffixe titre Hero', type: 'text', hint: 'avec nos formations', translatable: true },
    { key: 'hero_description', label: 'Description Hero', type: 'textarea', hint: 'Des programmes de formation conçus pour accélérer votre carrière et développer vos compétences.', translatable: true },
    { key: 'hero_image', label: 'Image Hero', type: 'image', hint: 'Image principale de la section Hero', translatable: false },
    // Jobs Week section
    { key: 'jobs_week_badge', label: 'Badge Jobs Week', type: 'text', hint: 'Programme Phare', translatable: true },
    { key: 'jobs_week_title', label: 'Titre Jobs Week', type: 'text', hint: 'Jobs Week', translatable: true },
    { key: 'jobs_week_subtitle', label: 'Sous-titre Jobs Week', type: 'text', hint: 'Programme Intensif de 5 Jours', translatable: true },
    { key: 'jobs_week_description', label: 'Description Jobs Week', type: 'textarea', hint: 'Un programme intensif conçu pour vous transformer en candidat compétitif.', translatable: true },
    { key: 'jobs_week_places_label', label: 'Label "places restantes"', type: 'text', hint: 'PLACES SEULEMENT', translatable: true },
    { key: 'jobs_week_program_label', label: 'Label "programme complet"', type: 'text', hint: 'Programme complet', translatable: true },
    { key: 'jobs_week_duration', label: 'Durée Jobs Week', type: 'text', hint: '5 jours intensifs', translatable: true },
    { key: 'jobs_week_cta', label: 'Texte bouton inscription', type: 'text', hint: "S'inscrire via WhatsApp", translatable: true },
    { key: 'jobs_week_cta_message', label: 'Message WhatsApp inscription', type: 'textarea', hint: "Bonjour, je souhaite m'inscrire à Jobs Week", translatable: true },
    { key: 'jobs_week_modules', label: 'Modules (jour par jour)', type: 'json', schema: 'modules', hint: 'Jour, titre et description pour chaque module', translatable: true },
    { key: 'jobs_week_benefits', label: 'Avantages Jobs Week', type: 'json', schema: 'benefits', hint: 'Titre + description pour chaque avantage', translatable: true },
    { key: 'jobs_week_included_items', label: 'Éléments inclus (liste)', type: 'json', schema: 'list', hint: 'Ex: ["Optimisation CV", "Entretiens blancs"]', translatable: true },
    // Formations section
    { key: 'formations_title', label: 'Titre Formations', type: 'text', hint: 'Nos Formations', translatable: true },
    { key: 'formations_subtitle', label: 'Sous-titre Formations', type: 'textarea', hint: 'Des programmes conçus par des experts pour vous aider à atteindre vos objectifs', translatable: true },
    // Program overview section
    { key: 'program_title', label: "Titre aperçu du programme", type: 'text', hint: 'Aperçu du Programme', translatable: true },
    { key: 'program_subtitle', label: 'Sous-titre aperçu du programme', type: 'textarea', hint: "Un parcours complet de 5 jours vers l'employabilité", translatable: true },
    // Trainer section
    { key: 'trainer_title', label: 'Titre section formateurs', type: 'text', hint: 'Vous êtes formateur ou organisation ?', translatable: true },
    { key: 'trainer_description', label: 'Description section formateurs', type: 'textarea', hint: 'Organisez vos formations à Malea Hub. Des installations premium, un environnement professionnel et un public motivé.', translatable: true },
    { key: 'trainer_button', label: 'Texte bouton formateurs', type: 'text', hint: 'Organisez votre formation', translatable: true },
    { key: 'trainer_message', label: 'Message WhatsApp formateurs', type: 'textarea', hint: 'Bonjour, je suis formateur et souhaite organiser une formation à Malea Hub', translatable: true },
  ],
  lounge: [
    // Hero section
    { key: 'hero_badge', label: 'Badge Hero', type: 'text', hint: 'Espace Premium', translatable: true },
    { key: 'hero_title_prefix', label: 'Préfixe titre Hero', type: 'text', hint: "L'espace", translatable: true },
    { key: 'hero_title_highlight', label: 'Mot mis en avant', type: 'text', hint: 'Lounge', translatable: true },
    { key: 'hero_title_suffix', label: 'Suffixe titre Hero', type: 'text', hint: 'de Malea Hub', translatable: true },
    { key: 'hero_description', label: 'Description Hero', type: 'textarea', hint: 'Un espace premium conçu pour la détente et les échanges professionnels', translatable: true },
    { key: 'hero_image', label: 'Image Hero', type: 'image', hint: 'Image principale de la section Hero', translatable: false },
    // Gallery section
    { key: 'gallery_title', label: 'Titre de la galerie', type: 'text', hint: 'Notre espace Lounge', translatable: true },
    { key: 'gallery_image_1', label: 'Photo galerie 1', type: 'image', hint: 'Espace salon', translatable: false },
    { key: 'gallery_image_1_alt', label: 'Légende galerie 1', type: 'text', hint: 'Espace salon', translatable: true },
    { key: 'gallery_image_2', label: 'Photo galerie 2', type: 'image', hint: 'Coin café', translatable: false },
    { key: 'gallery_image_2_alt', label: 'Légende galerie 2', type: 'text', hint: 'Coin café', translatable: true },
    { key: 'gallery_image_3', label: 'Photo galerie 3', type: 'image', hint: 'Espace détente', translatable: false },
    { key: 'gallery_image_3_alt', label: 'Légende galerie 3', type: 'text', hint: 'Espace détente', translatable: true },
    { key: 'gallery_image_4', label: 'Photo galerie 4', type: 'image', hint: 'Coin lecture', translatable: false },
    { key: 'gallery_image_4_alt', label: 'Légende galerie 4', type: 'text', hint: 'Coin lecture', translatable: true },
    // Usage section
    { key: 'usage_title', label: 'Titre Utilisations', type: 'text', hint: 'Utilisations du Lounge', translatable: true },
    { key: 'usage_items', label: 'Utilisations (cartes)', type: 'json', schema: 'usage', hint: 'Titre + description pour chaque usage', translatable: true },
    { key: 'usage_cta_button', label: 'Texte bouton visite', type: 'text', hint: 'Visiter le Lounge', translatable: true },
    { key: 'usage_cta_message', label: 'Message WhatsApp visite', type: 'textarea', hint: "Bonjour, je souhaite visiter l'espace Lounge", translatable: true },
    // Features section
    { key: 'features_title', label: 'Titre Équipements', type: 'text', hint: 'Équipements & Services', translatable: true },
    { key: 'features_items', label: 'Équipements (cartes)', type: 'json', schema: 'features', hint: 'Titre + description pour chaque équipement', translatable: true },
  ],
  events: [
    // Hero section
    { key: 'hero_badge', label: 'Badge Hero', type: 'text', hint: 'Annonces & Événements', translatable: true },
    { key: 'hero_title_prefix', label: 'Préfixe titre Hero', type: 'text', hint: 'Annonces &', translatable: true },
    { key: 'hero_title_highlight', label: 'Mot mis en avant', type: 'text', hint: 'Événements', translatable: true },
    { key: 'hero_title_suffix', label: 'Suffixe titre Hero', type: 'text', hint: 'à Malea Hub', translatable: true },
    { key: 'hero_description', label: 'Description Hero', type: 'textarea', hint: 'Découvrez nos annonces, événements à venir et opportunités au cœur de Malea Hub.', translatable: true },
    { key: 'hero_image', label: 'Image Hero', type: 'image', hint: 'Image principale de la section Hero', translatable: false },
    // Announcements section
    { key: 'announcements_title', label: 'Titre Annonces', type: 'text', hint: 'Nos prochains événements', translatable: true },
    { key: 'announcements_subtitle', label: 'Sous-titre Annonces', type: 'text', hint: 'Ne manquez aucune opportunité', translatable: true },
    { key: 'announcements_cta', label: 'Texte bouton "Voir les détails"', type: 'text', hint: 'Voir les détails', translatable: true },
    // Team section
    { key: 'team_title', label: 'Titre Équipe', type: 'text', hint: 'Notre Équipe', translatable: true },
    { key: 'team_subtitle', label: 'Sous-titre Équipe', type: 'textarea', hint: 'Des professionnels passionnés dédiés à votre réussite', translatable: true },
    // CTA section
    { key: 'cta_title', label: 'Titre CTA', type: 'text', hint: 'Vous souhaitez organiser un événement ?', translatable: true },
