...
//               Rejoindre<span style={{ color: 'var(--primary)' }}>un programme</span>
//             </h2>
//             <p className="mt-6 text-lg leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
//              Rejoignez un programme d'accompagnement dédié aux porteurs de projets innovants.
//             </p>
//             <br/>
//             <p className="mt-6 text-lg leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
...
//                Pour tous accompagnements sur vos projets
//                 </p>
